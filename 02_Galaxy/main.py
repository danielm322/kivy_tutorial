...
class MainWidget(RelativeLayout):
    ...
    ship = None
    SHIP_WIDTH = .1  # percent of the screen
    SHIP_HEIGHT = 0.035
    SHIP_BASE_Y = 0.04
    ...
    def update(self, dt):
        ...
        if not self.state_game_over and self.state_game_has_started:
            self.current_offset_y += self.SPEED * time_factor * self.height

            self.current_offset_x -= self.current_speed_x * self.width * self.SPEED_X * time_factor
